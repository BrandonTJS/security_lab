...
{
   var username = db.sanitize(req.body.userName);
   var password = db.sanitize(req.body.password);
...
function handleSignup(req,res,next)
{
   ...
   if (validateSignup(userName, firstName, lastName, password, verify, email, errors)) {
      var q = "SELECT * FROM User U WHERE U.userName = '" + db.sanitize(userName) + "'";
